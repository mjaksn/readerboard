#!/usr/bin/env python3
"""Run the relay client out of a checkout, with nothing installed.
...
both there and hands over to ``relayclient.app``. ``tools/signsim/run.py`` and
...
from relayclient.app import main  # noqa: E402 (the path has to be set up first)
